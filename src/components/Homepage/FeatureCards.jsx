...
const FeatureCards = () => {
  return (
    <section className="items-center text-black bg-white justify-center px-5 md:px-16 text-center">
        <h2 className="text-3xl font-poppins py-5">Our Features</h2>
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mt-10 mx-auto text-center gap-5 items-center justify-center">
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaFilePdf className="text-6xl text-orange-600 mb-3" />
        ...
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaChalkboardTeacher className="text-6xl text-orange-600 mb-3" />
        ...
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaHome className="text-6xl text-orange-600 mb-3" />
        ...
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaNewspaper className="text-6xl text-orange-600 mb-3" />
        ...
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaBook className="text-6xl text-orange-600 mb-3" />
        ...
        <div className="py-5 px-4 text-justify rounded shadow-lg bg-white border-t-2 border-blue-400">
          <FaCoins className="text-6xl text-orange-600 mb-3" />
